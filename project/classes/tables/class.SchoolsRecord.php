...
class SchoolsRecord extends AbstractRecordLBox
{
	...
	public static $dependingRecords	= array("SchoolsCitiesRegionsRecords", "TopRatedPhotosBySchoolsRecords",
											"SchoolsLastCreatedRecords", "SchoolsCitiesRegionsRecords",
	...
	protected $xTUserVotesRemaining;
	...
	/**
	 * vraci zbyvajici pocet hlasu momentalne prihlaseneho uzivatele pro fotky soutezicich teto skoly
	 * @return int
	 * @throws LBoxException
	 */
	public function getXTUserVotesRemaining() {
		try {
			if (is_numeric($this->xTUserVotesRemaining)) {
				return $this->xTUserVotesRemaining;
			}
			return $this->xTUserVotesRemaining	= LBoxConfigManagerProperties::getPropertyContentByName("max_user_votes_per_school")
													- $this->getXTUserVotedCount();
		}
		catch (Exception $e) {
			throw $e;
		}
