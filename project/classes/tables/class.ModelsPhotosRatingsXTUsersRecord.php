...
class ModelsPhotosRatingsXTUsersRecord extends AbstractRecordLBox
{
	...
	public function getPhoto() {
		try {
			...
			$photos			= $this->getBoundedM1Instance("PhotosRecords", $filter, $order, $limit, $whereAdd);
			$photos			->setIsTree(true);
			$this->photo	= $photos->current();
	...
	public function getSchool() {
		try {
			...
			return $this->school	= $this->getBoundedM1Instance("SchoolsRecords")->current();
		}
		catch (Exception $e) {
			throw $e;
		}
