<?php
/**
 * zkontroluje jestli record podle hodnoty controlu neexistuje podle nastaveneho colname
 */
class ValidatorAdminRecordNotExists extends ValidatorRecordNotExists
{
	/**
