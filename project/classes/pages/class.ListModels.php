...
//DbControl::$debug = true;
	...
	protected function getModels($limit	= false) {
		try {
			...
			$this->models[$key]	= new ModelsPhotosRatingsXTUsersRecords($filter, array("rating_count" => 0, "model_email" => 0), $limit);
			$this->models[$key]->setOutputFilterItemsClass("OutputFilterModelSchool");
			return $this->models[$key];
		}
		catch (Exception $e) {
			throw $e;
