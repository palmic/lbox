...
require_once PHPTAL_DIR_CORE .'/Namespace.php';

require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Comment.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Replace.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Content.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Condition.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Attributes.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Repeat.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/Define.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/OnError.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/TAL/OmitTag.php';
