...
require_once PHPTAL_DIR_CORE .'/Dom/Defs.php';
require_once PHPTAL_DIR_CORE .'/Namespace.php';

require_once PHPTAL_DIR_CORE .'/Php/Attribute/METAL/DefineMacro.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/METAL/UseMacro.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/METAL/DefineSlot.php';
require_once PHPTAL_DIR_CORE .'/Php/Attribute/METAL/FillSlot.php';
